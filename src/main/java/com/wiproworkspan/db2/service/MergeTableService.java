...
import com.wiproworkspan.db2.repo.MergeTableRepo;

@Service
public class MergeTableService {
	
	@Autowired
	private MergeTableRepo MTRepo;
...
/******************************* FUNCTION ******************************************************************/	
	...
	public List<MonitorJobsDTO> MonitorService() {

/******************************* SCHEDULE ******************************************************************/
		
	List<Object[]> schedules1=  MTRepo.findAllMaintainJobs();
...
//	   	    	System.out.println(sch2[0]);
//	   	    	System.out.println(sch2[1]);
//	   	    	System.out.println(sch2[2]);
//	   	    	System.out.println(sch2[3]);
//	   	    	System.out.println(sch2[4]);
//	   	    	System.out.println(sch2[5]);
//	   	    	System.out.println(sch2[6]);
//	   	    	System.out.println(sch2[7]);
